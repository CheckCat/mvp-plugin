...
Перед «pipeline complete» прогони `git status --short` и назови незакоммиченное поимённо (почему хвост грязен — в справочнике). Не коммить сам — молчание о грязном дереве это ложь о состоянии.
