...
| «Ревьюер написал CANNOT_VERIFY, но вердикт approve — значит всё нормально» | approve поверх непроверенных требований — не гейт. Это halt, и снимается он только тем, что ревьюер получает нужные данные |
